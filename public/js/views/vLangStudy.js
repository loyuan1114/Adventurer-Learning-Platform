...
function vLangStudy(){
  ...
  $('#view').innerHTML=back()+'<h3 class="vt">🌍 語言包 <span class="vsub">'+LANG_TOTAL+' 種語言・每語言一包・獎勵 1.3 倍</span></h3>'+
  '<div class="panel2" style="margin-bottom:10px;line-height:1.9;font-size:13.5px;border-left:4px solid var(--teal)">📖 挑一個想學的語言（含客家話四縣/海陸/大埔/饒平/詔安腔、閩南語臺灣/福建/潮州/海南腔、北越語），立即載入該語言專屬語言包出題（單字中⇄外配對）；答對可得 <b style="color:var(--gold2)">1.3 倍</b> 經驗／金幣／水晶，每個語言的答題數都會個別記錄。<br>📌 也可以先在「⚙️ 設定」裡把常用語言設為偏好。</div>'+
