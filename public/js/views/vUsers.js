...
'<div class="panel2" style="margin-bottom:14px"><b style="color:var(--gold2)">➕ 建立帳號（教師/學生）</b>'+
'<div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:10px;align-items:center">'+
'<select id="nuRole" style="width:auto" onchange="nuRoleChange(this)"><option value="teacher">👩‍🏫 教師</option><option value="student">👤 學生</option></select>'+
...
'<div style="font-size:11.5px;color:var(--mut);margin-top:6px">教師建立後可自行於教師端「📝 學生註冊」單筆新增或 TXT 批次匯入學生</div></div>'+
