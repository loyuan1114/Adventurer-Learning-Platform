...
- **💻 虛擬終端機**：AI 驅動的模擬終端介面，輸入指令 AI 即時回覆，支援 help / date / whoami / ls / cat / echo / stats / quiz / joke / exam 等指令，其餘指令自動由 AI 回答
- **📝 會考倒數**：首頁自動顯示國中教育會考倒數天數，九年級學生特別標示；AI 每日自動查詢最新考試日期，點擊「🔄 AI 更新日期」可即時刷新
- **🌍 首頁語言切換**：首頁新增語言偏好快速切換面板，一鍵選擇常用語言（繁中/簡中/英/日/韓/越/法/德/西/義/葡/俄/泰/印尼/馬來/阿拉伯/印地/土耳其），支援搜尋更多 211+ 種語言
- **🎬 影片專區修復**：修復影片專區點擊無回應的問題，懒加載參數轉發已修正
- **🔗 語言包修復**：修復語言學習模組懒加載參數轉發問題

## ✨ v4.0 新增

- **🌍 語言包**：211 種語言 × 8 大區（新增北越語・客家五腔・閩南四腔），代碼唯一可直接搜尋；老師／管理員可自選語言；AI 出題自動防失敗（本地 fallback＋重試＋拼音模式）
- **🎨 介面顏色主題**：8 款全新配色（深海藍／暗夜紫／翡翠綠／楓紅／夜櫻粉／墨青／純黑 OLED），設定頁一鍵切換
- **🖼 像素畫板**：16~256 全公開畫廊，人人可創作與參觀
- **🏛 社會科改版**：社會＝歷史・地理・公民
- **🎵 YouTube 音樂**：管理員可管理音樂庫，學生可推薦歌曲（審核制）
- **🏆 班級戰**：全校班級總答題數＋在線時間競賽
- **🧩 數獨 9×9**：py 出題（`sudoku_gen.py`）、同場競速＋個人最佳排位
- **🎀 娃娃一人限一個**
